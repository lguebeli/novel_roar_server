...
EVALUATION_CSV_FOLDER_PATH = "<local-path-to-evaluation-fingerprints-folder>"   #Example:   r".\fingerprints\evaluation"
TRAINING_CSV_FOLDER_PATH = "<local-path-to-training-fingerprints-folder>"       #Example:   r".\fingerprints\training"
