...
EVALUATION_CSV_FOLDER_PATH = "<local-path-to-evaluation-fingerprints-folder>"
TRAINING_CSV_FOLDER_PATH = "<local-path-to-training-fingerprints-folder>"
...
SIM_CORPUS_SIZE_V5 = 4000  # 4000 for 20 steps with 200 bytes/s
MAX_EPISODES_V6 = 3
MAX_STEPS_V6 = 5
MAX_STEPS_V99 = 500
