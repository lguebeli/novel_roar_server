...
from environment.state_handling import get_fp_path, is_multi_fp_collection
...
def report_fingerprint(mac):
    ...
    write_metrics_to_file(str(body["rate"]), str(body["fp"]), get_fp_path(), is_multi_fp_collection())
